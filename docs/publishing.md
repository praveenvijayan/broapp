...
Repository release v0.4.16 ships the launcher binaries built from the same
commit; it moves two packages: the core, which reports a running turn's usage
...
`>=0.4.6`. A created application installs `broapp@^0.4.5` and
`broapp-autoapp@^0.3.15`.
