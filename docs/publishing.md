...
Repository release v0.4.24 ships the launcher binaries built from the same
commit; it moves the launcher only: a view source or action that passes an
