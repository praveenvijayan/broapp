...
Repository release v0.4.26 ships the launcher binaries built from the same
commit; it moves the launcher only: a build refuses an acceptance step on an
