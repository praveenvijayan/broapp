...
Repository release v0.4.12 ships the launcher binaries built from the same
commit; it moves three packages: the core, whose in-process turn may defer a
