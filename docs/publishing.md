...
0.4.1, `broapp-ai-elements` at 0.4.3, and `broapp-autoapp` at 0.3.5
(2026-09-12). Earlier the same day: 0.4.5 with the launcher at 0.3.4, 0.4.4 with 0.3.3, 0.4.3 with the launcher at 0.3.2 and the panel at 0.4.2, then 0.4.2 with 0.3.1, 0.4.1 with 0.3.0, and
...
Repository release v0.4.6 ships the launcher binaries built from the same
commit; it moves the AI panel, for the running mark that stays the whole
turn, and the launcher, which depends on it and whose engineer stops walking
lesson ids. v0.4.5 before it moved only the launcher, for removal, the blank
