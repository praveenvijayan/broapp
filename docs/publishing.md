...
Repository release v0.4.13 ships the launcher binaries built from the same
commit; it moves only the launcher, for a failed task that says which tool
